...
class SendSms():
    ...
    def Kigili(self): 
                    ...
                    if kigili.status_code == 202:
                         print(f"{Fore.LIGHTBLUE_EX} Toplam SMS: {self.adet}  {Style.RESET_ALL}{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! --> kigili.com ")
                         self.adet += 1
                    else:
                        raise 
                except :
                     print(f"{Fore.LIGHTBLUE_EX} Toplam SMS: {self.adet}  {Style.RESET_ALL}{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! --> kigili.com ")
